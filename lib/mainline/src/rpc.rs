...
pub const DEFAULT_BOOTSTRAP_NODES: [&str; 0] = [];

const REFRESH_TABLE_INTERVAL: Duration = Duration::from_secs(5);
const PING_TABLE_INTERVAL: Duration = Duration::from_secs(5);
